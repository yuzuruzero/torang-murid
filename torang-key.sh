...
echo ""
echo "=================================================================="
echo "  PERINTAH MURID (IP & key sudah otomatis). Pilih sesuai tempat paste:"
echo "------------------------------------------------------------------"
echo "  [1] Kalau SUDAH di Ubuntu/WSL (prompt: user@...:~\$) — paste ini:"
echo "        bash <(curl -fsSL $OFFICE_URL/static/murid.sh)"
echo ""
echo "  [2] Kalau di PowerShell / CMD (prompt: PS C:\\...> ) — paste ini:"
echo "        wsl bash -c \"curl -fsSL $OFFICE_URL/static/murid.sh | bash\""
echo "------------------------------------------------------------------"
echo "  PENTING: [1] AKAN ERROR kalau di-paste di PowerShell ('<' reserved)."
echo "  Ragu tempatnya? Pakai [2] — jalan dari PowerShell maupun CMD."
echo "=================================================================="
